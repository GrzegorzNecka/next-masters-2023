 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ProductVariantList on Product {\n  productVariantList {\n    id\n    name\n    color\n    price\n    sizes {\n      ... on SizeList {\n        id\n        size\n        total\n      }\n    }\n  }\n}"): typeof import('./graphql').ProductVariantListFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ProductListVariant on Product {\n  productVariants {\n    id\n    name\n    price\n    total\n    productType {\n      ... on Accesory {\n        id\n        color\n        stage\n      }\n      ... on Clothing {\n        id\n        color\n        size\n        stage\n      }\n    }\n  }\n}"): typeof import('./graphql').ProductListVariantFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
