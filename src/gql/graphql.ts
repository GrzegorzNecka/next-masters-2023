...
export type CartUpsertItemMutation = {
	upsertOrder?: { id: string; total: number; orderItems: Array<{ id: string }> } | null;
};
...
export type ProductSingleGetBySlugQuery = {
	products: Array<{
		description: string;
		id: string;
		slug: string;
...
export type ProductVariantGetByIdQuery = {
	product?: {
		variants: Array<
			| { id: string; name: string; color: ProductColor }
			| { id: string; name: string; color: ProductColor; size: ProductSize }
			| { id: string; name: string; size: ProductSize }
		>;
	} | null;
};
...
export type ProductsConnectionGetByCategorySlugQuery = {
	productsConnection: {
		edges: Array<{
			cursor: string;
			node: {
...
export type ProductsConnectionGetListQuery = {
	productsConnection: {
		edges: Array<{
			cursor: string;
			node: {
...
export type ProductsSearchByNameQuery = {
	products: Array<{
		id: string;
		slug: string;
		name: string;
...
export const ProductVariantsFragmentDoc = new TypedDocumentString(
  ...
  price
	...
	{ fragmentName: "ProductVariants" },
) as unknown as TypedDocumentString<ProductVariantsFragment, unknown>;
...
export const CategoriesGetAggregateDocument = new TypedDocumentString(`
  ...
  productsConnection(where: {categories_some: {slug: $slug}}) {
    ...
    `) as unknown as TypedDocumentString<
	CategoriesGetAggregateQuery,
	CategoriesGetAggregateQueryVariables
>;
...
export const CollectionsGetSlugsDocument = new TypedDocumentString(`
  ...
  collections(first: 4) {
    ...
    `) as unknown as TypedDocumentString<
	CollectionsGetSlugsQuery,
	CollectionsGetSlugsQueryVariables
>;
...
export const PorductListGetAggregateDocument = new TypedDocumentString(`
  ...
  productsConnection {
    ...
    `) as unknown as TypedDocumentString<
	PorductListGetAggregateQuery,
	PorductListGetAggregateQueryVariables
>;
export const ProductSingleGetBySlugDocument = new TypedDocumentString(`
  ...
  price
	...
	ProductSingleGetBySlugQuery,
	ProductSingleGetBySlugQueryVariables
>;
export const ProductVariantGetByIdDocument = new TypedDocumentString(`
  ...
  product(where: {id: $id}) {
    ...
    `) as unknown as TypedDocumentString<
	ProductVariantGetByIdQuery,
	ProductVariantGetByIdQueryVariables
>;
export const ProductsConnectionGetByCategorySlugDocument = new TypedDocumentString(`
  ...
  price
	...
	ProductsConnectionGetByCategorySlugQuery,
	ProductsConnectionGetByCategorySlugQueryVariables
>;
export const ProductsConnectionGetListDocument = new TypedDocumentString(`
  ...
  price
	...
	ProductsConnectionGetListQuery,
	ProductsConnectionGetListQueryVariables
>;
...
export const ProductsSearchByNameDocument = new TypedDocumentString(`
  ...
  price
	...
	ProductsSearchByNameQueryVariables
>;
